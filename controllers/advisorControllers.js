...
const Details = require('./../models/advisorModel');
...
module.exports.login_get = (req, res) => {
    res.render('advisorLogin');
}

module.exports.register_get = (req, res) => {
    res.render('advisorRegister');
}
...
module.exports.advisorSendOTP = async(req, res) => {
    ...
    res.status(200).render('advisorOTP', { phone, hash: fullHash, otp }); // this bypass otp via api only for development instead hitting twilio api all the time
